...
def getJaEnviou(vCelular, vCliente: str, vBD):
  
  if vCelular != '':
    sql = f"""select l.id
            from szchat_log_envio l
            where l.mensagem_id = 2
      ...
      if result == None:
        ...
        if ativacoes != None:
          ...
          for a in ativacoes:
              ...
              res = getJaEnviou(vCelular, a['cliente_id'], b) #retorna se já enviou a mensagem para o cliente/contrato
